...
test("a pre-freeze shared_scope is NOT migrated, and that is a decision", async () => {
  ...
  // is TRUE and now measured twice: `cfa4fff` is on no branch but this one (`git
  // merge-base --is-ancestor cfa4fff main` fails), and none of the four live universes
  ...
  // exact shape of the defect `c383a45` shipped: a store that predates the columns
