...
| [`docs/plan-bug-backlog-and-ci.md`](plan-bug-backlog-and-ci.md) | 203 | the five open COD bugs re-triaged against `4d80d65`, plus the GitHub Actions that should have caught two of them. |
