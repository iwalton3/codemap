...
Reviewed `main` (`2519800`) through `worktree-shared-review-hashscheme` (`e549c8d`), including the intended-state proposal in `PROPOSAL-shared-review-state.md` and the vdx contract in `/working/vdx-web/FRAMEWORK.md`.
